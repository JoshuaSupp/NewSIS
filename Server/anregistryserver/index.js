...
//AN Student Grade Report
// Route to generate and download PDF
app.get('/api/pdf', (req, res) => {
    // Fetch data from MySQL table
    db.query('SELECT * FROM an_registry', (error, results) => {
      ...
      doc.fontSize(20).text("AN Student Grades", 50 ,50,  { underline: true } );
      doc.moveDown();
...
app.get('/api/pdfcomments', (req, res) => {
    ...
    db.query('SELECT * FROM an_registry', (error, results) => {
      ...
      doc.fontSize(20).text("AN Student Comments", 50 ,50,  { underline: true } );
      doc.moveDown();
