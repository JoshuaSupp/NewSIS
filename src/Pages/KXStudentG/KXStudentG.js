...
<h2 style={{paddingBottom:"5%",marginTop:"7%",marginBottom:'40px'}}>Knowledge Explorers Student Grades</h2>
  ...
  return(
          <tr style={{lineHeight: "20px",backgroundColor: "rgb(241, 110, 110)"}}>
           ...
           <td style={{backgroundColor:'white',height:'100px',width:'110px',marginLeft:'50%'}}> {item.puzzle_06} </td>
            </div>
            <td>
            {item.total_grade}
            </td>
