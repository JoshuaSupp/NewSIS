...
<Navbar/>
    ...
    <h2 style={{marginLeft:"100%"}}>Welcome to PD Accounts page</h2>
        
      <div>
      <button class="add" style={{color:'black',marginLeft:'5%',width:'200px',height:'50px',fontSize:'20px',backgroundColor:'#FF8040'}}><a href="/PDRegistry">Back To PD Registry</a></button>
    
      </div>

          <a href="/CreatePDLogin">
            <div class="add">- Add PD Student Account - </div>
          </a>
        </div> 
    ...
    return(
          ...
          <td style={{width:'20px',background:' #BFBFBF',borderRadius:'10px'}}>            
            ...
            <Link to={`/updatepds/${item.id}`}  >Update </Link>
          </td>
          </tr>
           )
