...
import './UpdateANG.css'
import { useNavigate, useParams } from 'react-router-dom'
import axios from 'axios';
import Navbar from '../../Components/Navbar/Navbar';

function UpdateANStudentG(){
    ...
    useEffect(()=> {
        axios.get('http://localhost:5002/edit/'+id)
        .then(res => {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault();
        axios.put('http://localhost:5002/update/'+id, {full_name,puzzle_01,puzzle_02,puzzle_03,puzzle_04,puzzle_05,puzzle_06,total_grade})
        .then(res => {
            if(res.data.updated){
                navigate('../ANStudentG')
            }else{
 ...
 <button class="button button1"><a href="/AnStudentG">Back To AN Student Grades</a></button>
    <h1>Update AN Student Grades</h1>
...
export default UpdateANStudentG